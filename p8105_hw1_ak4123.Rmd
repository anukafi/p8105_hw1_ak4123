...
### _Mean of the each variable in the dataframe_
```{R}
...
## _Apply the as.numeric function to the logical, character, and factor variables_
```{r results = 'hide'}
...
## _Convert character variable from character to factor to numeric and convert factor variable from factor to character to numeric_
```{R}
